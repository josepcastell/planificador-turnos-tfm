...
def render_schedule_calendar_html(
    ...
    def day_body_html(day_assignments: list[dict[str, str]]) -> str:
        ...
        for franja in franges:
            ...
            for area in ["DIR", "HUB", "DEL", "ALTRES"]:
                area_slots = [
    ...
    return (
        ...
        '<span class="schedule-calendar-legend-item"><span class="schedule-calendar-swatch" style="background:#dbeafe"></span>DIR</span>'
        '<span class="schedule-calendar-legend-item"><span class="schedule-calendar-swatch" style="background:#dcfce7"></span>HUB</span>'
        '<span class="schedule-calendar-legend-item"><span class="schedule-calendar-swatch" style="background:#ede9fe"></span>Delta</span>'
