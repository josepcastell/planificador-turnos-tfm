"""Comitè assignments per facultatiu — força una màquina de l'ÀREA indicada
(qualsevol àrea que defineixi l'usuari al catàleg) aquell dia."""
...
def save_comite_assignments(
    ...
    # comite_type = àrea lliure: només cal que no estigui buida.
    out = out[out["comite_type"].astype(str).str.strip() != ""].copy()
