...
Si un facultatiu té `allowed_areas = "ZONA_A;ZONA_B"`, no se li pot
assignar cap slot ubicat a una altra àrea. Si el camp està buit, no
s'apliquen restriccions (pot anar a qualsevol lloc).
...
def allowed_areas_eligibility_blocks(
    ...
    # Els slots sense àrea definida (p.ex. les revisions) NO
